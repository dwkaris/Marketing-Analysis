...
i) Which variable largely influence if someone will click on the add?

ii) Which country has most people who clicked on the add?

iii) What is the mean, quantile, and variance of the numerical variables of people who clicked on the add?

iV) How does Daily time spent on the site and Area income affect clicking in the advert?

v) How does Age and Gender affect clicking in the advert?

vi) How does Timestamp and Daily Internet Usage affect Clicking on the ad?

###Data Mining Success Criteria
Our success criteria will be measured by the following criteria;
-       Determining the post popular  times the cars are hired and returned

## DATA UNDERSTANDING
In this project, we are using data collected y our client In the past, she ran ads to advertise a related course on the same blog and collected the data in the process.
...
The dataset loaded below was is available in the following link [http://bit.ly/IPAdvertisingData].
```{r, echo=TRUE}
## Load data set 
...
d) Validity and Uniformity

We make sure our dataset is uniform here. We set the case of our rows to lowercase and we strip our columns to remove white spaces if.
...
```
We removed white space from our columns and rows in order to avoid syntax errors that may arise due to white spaces.
...
Oder people click on the ads more than younger people
